...
) (state.State, types.BlockID, *types.ExtendedCommit) {
	t.Helper()
...
func makeState(t *testing.T, nVals, height int) (state.State, dbm.DB, map[string]types.PrivValidator) {
