...
// source: badrootdseitendermint.p2p/types.proto
...
func init() {
	proto.RegisterType((*ProtocolVersion)(nil), "badrootdseitendermint.p2p.ProtocolVersion")
	proto.RegisterType((*NodeInfo)(nil), "badrootdseitendermint.p2p.NodeInfo")
	proto.RegisterType((*NodeInfoOther)(nil), "badrootdseitendermint.p2p.NodeInfoOther")
	proto.RegisterType((*PeerInfo)(nil), "badrootdseitendermint.p2p.PeerInfo")
	proto.RegisterType((*PeerAddressInfo)(nil), "badrootdseitendermint.p2p.PeerAddressInfo")
}

func init() { proto.RegisterFile("tendermint/types.proto", fileDescriptor_c8a29e659aeca578) }
